...
const $containerCidades = document.getElementsByClassName( 'containerCidades' );

const geraOptionsEstados = ( $select, cidades ) => {
...
const atualiza = () => exibeCidades( getCidades( $select.value, cidades ), $containerCidades );
