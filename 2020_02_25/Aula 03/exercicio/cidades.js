...
const geraOptionsEstados = ( elemento, cidades ) => {

  // return string = cidades.map( ( estado ) => console.log( estado.nome ) );
...
const exibeCidades = ( arrayCidades, elemento ) => {
    ...
    if( ( contador % 2 ) == 0 ){
      ...
      elemento.innerHTML += `
        <div class="containerCidade">
          ...
          <div class="containerCidadeImpar">
            ${cidade}
          </div>
        </div>
      `;
...
const atualiza = () => {
  limpaCidades( $containerCidades );
  exibeCidades( getCidades( $select.value, cidades ), $containerCidades );
};

geraOptionsEstados( $select, cidades );
